  ...
  private async importRow(row: any, rowNum: number, result: ImportResult): Promise<void> {
    ...
    await this.prisma.project.create({
      data: {
        ...
        descriptionEN: this.getStringValue(row, 'Purpose of AI system') || '',
        descriptionFR: this.getStringValue(row, 'Purpose of AI system') || '',
        primaryUsers,
        developedBy,
        vendorName: this.getStringValue(row, 'Vendor name'),
        status,
        statusYear: this.getYearValue(row, 'Status date'),
        capabilitiesEN: this.getStringValue(row, 'AI system capabilities'),
        capabilitiesFR: this.getStringValue(row, 'AI system capabilities'),
        isAutomatedDecisionSystem,
        openGovAiaId: this.getStringValue(row, 'Algorithmic Impact Assessment'),
        dataSourcesEN: this.getStringValue(row, 'Data sources'),
        dataSourcesFR: this.getStringValue(row, 'Data sources'),
        involvesPersonalInfo,
        personalInformationBanksEN: this.getStringValue(row, 'Personal Information Banks'),
        personalInformationBanksFR: this.getStringValue(row, 'Personal Information Banks'),
        hasUserNotification,
        atipRequestRefsEN: this.getStringValue(row, 'Access to Information request'),
        atipRequestRefsFR: this.getStringValue(row, 'Access to Information request'),
        outcomesEN: this.getStringValue(row, 'AI system results'),
        outcomesFR: this.getStringValue(row, 'AI system results'),
